...
* Create a git repository with `$ git init` and add your git user information `$ git config user.name "smartFarm" && git config user.email ""`
* Create a remote repository on [Github][github] with the name `smart-farm`. It should look after: `https://github.com/smartfarm/smart-farm.git`
